          ...
          <div className="container py-md-4">
            <div className="row footer-top-29">
              <div className="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
                ...
                <p>
                  Address : Assignment Space, Kathmandu, Nepal
                </p>
                <p className="my-2">
                  Phone : <a href="tel:+(01) 234 4567">+(977) 9841122333</a>
                </p>
                <p>
                  Email : <a href="mailto:assignmentspace@example.com">assignmentspace@example.com</a>
                </p>
        ...
        <section className="w3l-copyright text-center">
          <div className="container">
            <p className="copy-footer-29">
              © 2024 Assignment Space. All rights reserved. Design by
